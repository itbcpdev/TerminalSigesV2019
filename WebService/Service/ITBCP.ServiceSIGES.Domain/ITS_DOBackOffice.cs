...
{
    public interface ITS_DOBackOffice
    {
        ...
        List<TS_BETerminal> SP_ITBCP_LISTAR_TERMINALES(TS_BETerminal input);
        ...
        bool SP_ITBCP_ACTUALIZAR_AFILIACION_TARJETA(string tarjeta, decimal puntos, decimal valor_acumulado);
